...
/**
 *struct buffer - structure with the buffer
 *
 *@buffer: buffer allocated in 1024 bytes
 *@n_chars: quantity of chars saved in the buffer
 *@buf_init_pox: initial position of the buffer
 */
...
/**
 *struct valid_string - structure of pointer to the functions
 *
 *@format: printf string to convert
 *@create: pointer to a function
 */
